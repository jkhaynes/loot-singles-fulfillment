...
public class OrderValidationTests
{
    ...
    [InlineData(
        "1",
        "Pokemon - SV: Black Bolt:  - #067/086 - Double Rare - Near Mint",
        FailureType.MissingProductName
    )]
    [InlineData(
        "1",
        "Pokemon - : Genesect ex - #067/086 - Double Rare - Near Mint",
        FailureType.MissingSet
    )]
    [InlineData(
        "1",
        "Pokemon - SV: Black Bolt: Genesect ex - Double Rare - Near Mint",
        FailureType.MissingCollectorNumber
    )]
    [InlineData(
        "1",
        "Pokemon - SV: Black Bolt: Genesect ex - #067/086 - Double Rare - Unknown",
