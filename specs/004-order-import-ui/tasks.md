...
- [ ] T005 [P] [US1] Integration test in `backend/tests/LootSingles.IntegrationTests/ImportUi/ImportsControllerAuthTests.cs`: `POST /api/imports` without a session returns `401` and invokes no import processing.
