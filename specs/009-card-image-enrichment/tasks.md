...
- [ ] T036b [US3] Implement `MagicSetNameNormalizer.NormalizeCandidates` in `backend/src/LootSingles.Infrastructure/CardCatalog/MagicSetNameNormalizer.cs` per research.md §3's live-verified candidate table, to make T034b pass
