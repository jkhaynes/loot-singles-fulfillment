...
Gathering, and Disney Lorcana product lines, resolved live (no caching) from three external
per-game catalog sources — Pokémon TCG API, Scryfall, and Lorcast. Matching is conservative
...
│   ├── PokemonTcgApiCardCatalogProvider.cs     # new
