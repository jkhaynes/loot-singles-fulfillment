...
- `/speckit-clarify` session on 2026-08-20 resolved three further open questions (multi-order-per-file scope, synchronous processing with progress indication, best-effort duplicate detection) and closed three remaining edge-case gaps (whole-file-unreadable, duplicate product lines, garbled fields) via new/updated requirements (FR-004, FR-005, FR-013, FR-014, FR-015). 16/16 items pass; no regressions.
